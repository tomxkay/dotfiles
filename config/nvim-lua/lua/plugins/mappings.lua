...
nmap('<Leader>Gfc', ':Telescope git_commits<CR>')
nmap('<Leader>GfC', ':Telescope git_bcommits<CR>')
nmap('<Leader>Gfb', ':Telescope git_branches<CR>')
nmap('<Leader>GfS', ':Telescope git_status<CR>')
nmap('<Leader>Gfs', ':Telescope git_stash<CR>')
